...
public:
  ...
  uint8_t attach(int pin, int min, int max, int maxAngle); // as above but also sets min and max values for writes. 
  void detach();
...
private:
   ...
   uint16_t maxAngle;		     // useful for defining non 180 degree servo (continuous servo)
